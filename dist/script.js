...
var checkNumInputs = function checkNumInputs(selector) {
  ...
  numInputs.forEach(function (item) {
    item.addEventListener('input', function () {
      // event 'input' срабатывает когда пользователь что-то вводит/пишет
    ...
    return regeneratorRuntime.async(function postData$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            // url - адрес сервера, куда отправляется data
            document.querySelector('.status').textContent = message.loading; // вставка теста в сообщение

            _context.next = 3;
            return regeneratorRuntime.awrap(fetch(url, {
              // await дает понять js, что надо дождаться окончания операции, перед кот он стоит
              method: 'POST',
              body: data
            }));
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      postData('assets/server.php', formData).then(function (res) {
        ...
        return statusMessage.textContent = statusMessage.failure;
      }).finally(function () {
        clearInputs();
        setTimeout(function () {
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _noEmptyFields__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./noEmptyFields */ "./src/js/modules/noEmptyFields.js");

 // функция для всех модальных окон

var modals = function modals() {
  Object(_noEmptyFields__WEBPACK_IMPORTED_MODULE_1__["default"])('.popup_calc_button');
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      ...
      item.addEventListener('click', function (e) {
        // e - event, например не кнопка, а ссылка, кот перезагрузит страницу, а нам это не нужно
        if (e.target) {
          e.preventDefault();
...
/***/ "./src/js/modules/noEmptyFields.js":
/*!*****************************************!*\
  !*** ./src/js/modules/noEmptyFields.js ***!
  \*****************************************/
/*! exports provided: default */
...
var noEmptyFields = function noEmptyFields(btn) {
  var requiredFields = document.querySelectorAll('[data-validation]').values();
  var modalBtn = document.querySelector(btn);
  modalBtn.addEventListener('click', function (e) {
    e.preventDefault();
    console.log(requiredFields); // if (requiredFields === ''){
    //     // alert('Пожалуйста, заполните все поля формы.')
    // }
  });
};

/* harmony default export */ __webpack_exports__["default"] = (noEmptyFields);
...
var tabs = function tabs(headSelector, tabSelector, contentSelector, activeClass) {
  var display = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 'block';
  var header = document.querySelector(headSelector);
  ...
  header.addEventListener('click', function (e) {
    // обработчик навешивается на всю область клика
    var target = e.target;
